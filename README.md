Better Than Vibes (BTV) is a data pruning, prioritization and selection tool that uses the information content of data labels. See `demo.ipynb` for more details.
